  ...
  return (
    <Section title="Schedule Meeting">
      <div className="schedule-container">
        {/* Remove the temporary form since we're using the permanent form */}
        <div className="permaForm">
          <div className="form-container">
            <div className="form-header">
              ...
              <p>Enter the details to start the meeting or schedule the meeting</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-body">
                ...
                <div className="input-wrapper half-box time">
                  <span className={`custom-placeholder ${startTime ? "filled" : ""}`}>
                ...
                <div className="input-wrapper half-box time">
                  <span className={`custom-placeholder ${endTime ? "filled" : ""}`}>
                    {endTime || "End-Time"}
                  </span>
                  <input
                    className="inside-time"
